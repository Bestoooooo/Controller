...
/* Definitions for hChargeProcessT */
osThreadId_t hChargeProcessTHandle;
const osThreadAttr_t hChargeProcessT_attributes = {
  .name = "hChargeProcessT",
  .stack_size = 128 * 4,
...
/* Definitions for hReadCpTask */
osThreadId_t hReadCpTaskHandle;
const osThreadAttr_t hReadCpTask_attributes = {
  .name = "hReadCpTask",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for hModbusTask */
osThreadId_t hModbusTaskHandle;
const osThreadAttr_t hModbusTask_attributes = {
  .name = "hModbusTask",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
...
/* USER CODE BEGIN Header_ChargeProcessTask */
/**
  * @brief  Function implementing the hChargeProcessT thread.
...
/* USER CODE BEGIN Header_ReadCpTask */
/**
* @brief Function implementing the hReadCpTask thread.
* @param argument: Not used
* @retval None
*/
...
void ReadCpTask(void *argument)
{
  ...
  /* USER CODE END ReadCpTask */
}

/* USER CODE BEGIN Header_ModbusTask */
/**
* @brief Function implementing the hModbusTask thread.
* @param argument: Not used
* @retval None
*/
