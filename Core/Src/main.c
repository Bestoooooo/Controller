...
/* Definitions for hStatusTask */
osThreadId_t hStatusTaskHandle;
const osThreadAttr_t hStatusTask_attributes = {
  .name = "hStatusTask",
  .stack_size = 128 * 4,
...
/**
* @brief Function implementing the hStatusTask thread.
* @param argument: Not used
* @retval None
*/
